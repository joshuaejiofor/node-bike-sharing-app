...
node_cron_1.default.schedule('0 */30 * * * *', () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const stations = yield weather_api_1.getWeatherReport('Philadelphia').then((body) => {
            console.log('Successfully retrieved weather info', body);
            return body;
        })
            .catch((error) => {
            throw error;
        ...
        const weather = yield station_api_1.getStations().then((body) => {
            console.log('Successfully retrieved bicycle availability info', body);
            return body;
        })
            .catch((error) => {
            throw error;
